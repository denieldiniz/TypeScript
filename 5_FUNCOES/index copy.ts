...
function calculadora(numeros: number[], operacao: string | undefined) {
...
function boasVindas(usuarioLogado: Object) {
...
function detalharCachorro(cachorro: Cachorro) {
    if('raca' in cachorro) {
...
function pontuar(avaliacao: Avaliacao) {
