...
type textOrNull = string | null; // 08 - Type
...
function App() {
  ...
  //------------------------------------------------------
  // 08 - Type
  const umTexto: textOrNull = "receba um texto";
  let outroTexto: textOrNull = null;
  outroTexto = "opa";
  // umTexto = "Texto recebido";  // da erro por ser uma constante
  ...
  return (
    <appContext.Provider value={contextValue}>
      <div className="App">
        ...
        <br />
        {/* 08 - Type ------------------------- */}
        {umTexto && <div>"tem texto na variavel unTexto"</div>}
        {outroTexto && <div>"tem texto na variavel outroTexto"</div>}
        <br />
        <br />
        {/* 09 - Context API ------------------ */}
        <Context />
